<?php session_start();
	if(isset($_SESSION['writingSite_sessid'])) {
...
<html>
  <head>
    ...
    <title>writingSite Admin | Log in</title>
...
?>
    <div class="login-box">
      <div class="login-logo">
        <a href="index2.html"><b>writingSite</b>ADMIN</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">Sign in to start your session</p>
        <form action="php/login-exec.php" method="post">
