...
if(isset($_POST['Submit'])){
	...
	$description_bottom=$_POST['bottom'];
		$sql = "UPDATE blog SET title='$title',meta_description='$meta_description',meta_words='$meta_words',description_top='$description_top',description_bottom='$description_bottom',description_mid='$description_mid' WHERE content_id=1658";
          ...
          <div class="box">
                ...
                <div class="box-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php
$sql = "SELECT * FROM blog WHERE content_id = 1658";
