...
$qry_a = mysqli_query($link,"SELECT * FROM writers_requests where order_id = '".$order_id."' and status = 1");
...
<!-- Content Header (Page header) -->
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Order's Requests</li>
          </ol>
        </section>
          ...
          <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <?php
					if($count_a > 0){
						$sql = "SELECT * FROM writers_requests a, writers b, academic_level c where a.writer_id = b.writer_id and b.academic_level = c.act_level_id and a.order_id = '".$order_id."' and a.status = 1";
					}else{
						$sql = "SELECT * FROM writers_requests a, writers b, academic_level c where a.writer_id = b.writer_id and b.academic_level = c.act_level_id and a.order_id = '".$order_id."'";
					}
$qry = mysqli_query($link,$sql) or die(mysqli_error($link));
...
while ($rs = mysqli_fetch_array($qry)) {
	...
	?>
                      <tr>
						...
						if($count_a > 0){
						?>
                        <a href="#" class="btn btn-default">Request Accepted</a>
                        <?php
						}else{
						?>
                        <a data-toggle="modal" href="#awardModal<?php echo $writer_id; ?>" class="btn btn-primary">Accept Request</a>
                        <?php
						}
						?>
                        </td>
                      ...
                      <div class="modal-dialog">
                        ...
                        <form role="form" action="php/register-submit.php" method="post">
                          ...
                          <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" name="request_acceptance">Yes</button>
                          </div>
