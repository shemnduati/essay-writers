...
if(isset($_POST['Submit'])){
	...
	$description_bottom=$_POST['bottom'];
		$sql = "UPDATE blog SET title='$title',meta_description='$meta_description',meta_words='$meta_words',description_top='$description_top',description_bottom='$description_bottom',description_mid='$description_mid' WHERE content_id=1648";
...
<!-- Content Header (Page header) -->
        <section class="content-header">
          <h1>
            Home - The first page of your website (content page). 
          </h1>
          <ol class="breadcrumb">
...
$sql = "SELECT * FROM blog WHERE content_id = 1648";
